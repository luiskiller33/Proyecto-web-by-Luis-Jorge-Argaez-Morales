...
2. **[Admin Panel](https://github.com/luiskiller33/paneladminpage):** La herramienta de gestión empresarial con reportes, estadísticas y control de inventario.
3. **[Backend Server](https://github.com/luiskiller33/backendserver):** API centralizada que gestiona la base de datos, autenticación y lógica de negocio (alojada en Render).
